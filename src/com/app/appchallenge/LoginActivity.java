...
public class LoginActivity extends SherlockFragmentActivity implements
	...
	private void showAddressDialog(){
		...
		addressDialog.show(getSupportFragmentManager(), FRAG_TAG_ADDRESS_DIALOG); 
	}
	...
	private void hideLoadingDialog(){
		DialogFragment dialog = ( (DialogFragment)getSupportFragmentManager().findFragmentByTag(FRAG_TAG_LOGIN_DIALOG) ); 
		if( dialog != null ){
			dialog.dismiss();
		}
	}
